...
import HasBalanceERC20 from '../../../../components/accessSchemas/accessConditions/hasBalanceERC20';
...
describe('hasBalanceERC20 tests', () => {
  beforeEach(() => {
  ...
  test('It renders', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByDisplayValue(54321)).toBeVisible();
  ...
  test('Updates workflow', async () => {
    ...
    await waitFor(() => {
      expect(mockAccessValidatorInstance.updateAccessCondition).toHaveBeenCalledWith(
        { index: 0, minBalance: 543211, decimals: 18 },
      );
