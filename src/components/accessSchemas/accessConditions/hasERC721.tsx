...
function HasERC721({ index }: { index:number }) {
  ...
  // useEffect to fetch contract name as proxy for existence of ERC721 contract
  useEffect(() => {
    const fetchName = async () => {
      if (accessCondition?.contractAddress && accessCondition?.key === 'hasERC721') {
        try {
